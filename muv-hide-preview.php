...
/*
 * muv - Hide Preview
 * Copyright (C) 2016 - 2017, Meins und Vogel GmbH / muv.com - info@muv.com
 *
...
/* Hooks */
register_activation_hook(MUV_HP_FILE, array(muv\HidePreview\Wordpress\Install::class, 'init'));
register_deactivation_hook(MUV_HP_FILE, array(muv\HidePreview\Wordpress\Deactivate::class, 'init'));
register_uninstall_hook(MUV_HP_FILE, array(muv\HidePreview\Wordpress\Uninstall::class, 'init'));
