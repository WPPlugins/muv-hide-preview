...
class Verstecken {
	...
	add_settings_section('muv-hp-verstecken-aktivieren', __('Verstecken aktivieren', 'muv-hide-preview'), array(self::class, 'sectionVersteckenAktivierenBeschreibung'), 'muv-hp-settings-verstecken');
	...
	register_setting('muv-hp-settings-verstecken', 'muv-hp-verstecken-aktiv', array(self::class, 'versteckenAktivierenValidate'));

	
	add_settings_section('muv-hp-verstecken-bereiche-inkl', __('Zu versteckte Bereiche', 'muv-hide-preview'), array(self::class, 'sectionVersteckenBereicheInklBeschreibung'), 'muv-hp-settings-verstecken');
	...
	register_setting('muv-hp-settings-verstecken', 'muv-hp-verstecken-bereiche-inkl', array(self::class, 'versteckenBereicheInklValidate'));

	
	add_settings_section('muv-hp-verstecken-bereiche-exkl', __('Anzuzeigende Bereiche', 'muv-hide-preview'), array(self::class, 'sectionVersteckenBereicheExklBeschreibung'), 'muv-hp-settings-verstecken');
	...
	register_setting('muv-hp-settings-verstecken', 'muv-hp-verstecken-bereiche-exkl', array(self::class, 'versteckenBereicheExklValidate'));
    }
